...
const MultiTagDeleteDialog = () => {
  ...
  }, [selectedIds, fetchTags, closeDialog]);
  ...
  return React.createElement(
    ...
    confirming && React.createElement(
      ...
      React.createElement(
        ...
        affectedNoteCount > 0 && React.createElement(
          "p",
        ...
        React.createElement(
          ...
          React.createElement(
            "button",
            { className: "ui button", onClick: cancelDelete },
            "Cancel"
          ),
          React.createElement(
            "button",
            { className: "ui red button", onClick: handleConfirmDelete },
            "Yes, Delete"
          )
        )
      )
